        ...
        <table role='presentation' style='width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;'>
          <tr>
            <td align='center' style='padding:40px 20px 30px 20px;background:whitesmoke'>
              <table>
                  <tr>
              <td><img src='https://www.telkom.co.id/data/image_upload/page/1594108255409_compress_logo%20telkom%20indonesia.png' alt='telkom' width='300' style='height:auto;display:block;' />
              </td>
              <td><img src='https://1.bp.blogspot.com/-_Mg-3HifAas/X0JjnJRTgII/AAAAAAAAHD0/CwkFvAh9KGUYhpQMr71v0idEYMRilR6ywCLcBGAsYHQ/s1000/logo-bumn-terbaru.png' alt='bumn' width='300' style='height:auto;display:block;' />
              </td>
            </tr>
              </table>
            </td>
              ...
              <table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;'>
                <tr>
                  <td style='padding:0 0 36px 0;color:#153643;'>
                    ...
                    <p style='font-size:20px;margin:0 0 5px 0;font-family:Arial,sans-serif;color: black;' align='center'>$nidn</p>
                    <p style='font-size:20px;margin:0 0 5px 0;font-family:Arial,sans-serif;color: black;' align='center'>$alamat</p>
                    <p style='font-size:20px;margin:0 0 25px 0;font-family:Arial,sans-serif;color: black;' align='center'>$telp</p>
                    <p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;' align='center'>Terimakasih telah menjadi dosen setia kami,</p>
