...
$mail = new PHPMailer(true);
	...
	$id = $_GET['id'];
	$qe = mysqli_query($koneksi, "SELECT * FROM dosen WHERE nidn='$id'") or die (mysqli_error());
                        ...
                        <div class="panel-heading" style="">
                            <div class="row">
                                <div class="col-md-12 p-5 pt-2">
                                    <h3><i class="fas fa-home mr-3"></i>SEND MAIL - dosen PEMENANG</h3><hr>
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <tr>
                                            <div class="form-group">
                                                <td>No dosen</td>
                                                <td><input class="form-control" type="text" name="nidn" id="nidn" size="50" readonly="" value="<?php echo $qpeser ['nidn'] ?>"></td>
                                            </div>
				                        </tr>
...
try {
  ...
  //  $mail->addAttachment('/var/tmp/file.tar.gz');         //Add attachments
   ...
   $mail->AddEmbeddedImage("telkom.png", "telkom", "telkom.png");
    ...
    $mail->Subject = 'UNDANGAN PEMENANG dosen TERBAIK';
    $mail->Body    = "
    <head>
      <style>
